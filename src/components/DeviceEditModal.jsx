...
const DeviceEditModal = ({ device, onSave, onCancel }) => {
  ...
  const typeConfig = DEVICE_TYPES[deviceData.type];
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto transition-colors duration-200">
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Tipo de dispositivo (solo lectura en edición) */}
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Tipo de Dispositivo
              </label>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                El tipo de dispositivo no se puede cambiar después de la creación
              </p>
            </div>
